...
#SBATCH --tmp=20g
#SBATCH --job-name=monte-carlo_100M_samples_expansion_50
#SBATCH --output=monte-carlo_100M_samples_expansion_50.out
#SBATCH --error=monte-carlo_100M_samples_expansion_50.err
