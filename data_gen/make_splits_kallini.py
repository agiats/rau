...
parser = argparse.ArgumentParser(description="Divide generated sentences into splits")

parser.add_argument(
    "-s", "--sample_file", type=str, default="", help="Path to sample file"
)
parser.add_argument(
    "-S",
    "--sample_folder",
...
parser.add_argument("-O", "--output_folder", type=str, help="Location of output files")
parser.add_argument("-tr", "--train", type=float, default=0.8, help="Train proportion")
parser.add_argument("-ts", "--test", type=float, default=0.1, help="Test proportion")
parser.add_argument("-dv", "--dev", type=float, default=0.1, help="Dev proportion")
parser.add_argument("-n", "--num_splits", type=int, default=10, help="Number of splits")
...
if args.sample_file == "" and args.sample_folder == "":
    ...
    print("Please provide either a single file OR a folder containing sample files")
    ...
    for s in sample_files:
        create_splits(
            os.path.join(args.sample_folder, s),
            args.num_splits,
            args.train,
            args.test,
            args.dev,
