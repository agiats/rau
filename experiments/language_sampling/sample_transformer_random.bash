...
# Usage:
#   experiments/language_sampling/sample_transformer_random.bash \
...
model_tag="transformer_L${parameter_seed}_V${vocab_size}"
...
# 2) Initialize random Transformer model
...
echo "[done] Transformer random sampling at $out_dir"
