...
SECTIONS = {
    'MD': {
        '1987': [5, 10, 18, 21, 22, 26, 32, 35, 43, 47, 48, 49, 51, 54, 55, 56, 57, 61, 62, 65, 71, 77, 79, 81, 90, 96, 100, 105, 122, 125],
        '1988': [12, 13, 14, 17, 23, 24, 33, 39, 40, 47, 48, 54, 55, 59, 69, 72, 73, 76, 78, 79, 83, 84, 88, 89, 90, 93, 94, 96, 102, 107],
        ...
        for year, sections in tqdm(year_sections.items(), desc="Years"):
            ...
            for section in tqdm(sections, desc=f"Sections ({year})", leave=False):
                ...
                if not matching_sections:
                    print(f"Warning: No matching section found for pattern: {year_path}/{section_pattern}")
                    continue
